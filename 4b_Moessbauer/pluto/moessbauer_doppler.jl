...
# ╔═╡ 4252e33d-59e4-42ec-824b-4962a33ac033
using Plots
...
# ╔═╡ 67a9572e-bbed-11f0-86f4-2755bb9bdc22
md"""
## Mössbauer 1958
"""
...
Erecoil = E0^2 / (2 * M * c_0^2) |> u"eV"

# ╔═╡ 05d25642-e394-4a88-8d92-c0c4606b100b
Edoppler(T) = E0 * sqrt(k_B * T  / (M * c_0^2)) |> u"eV"

# ╔═╡ cc747e4e-464e-47f0-baa1-15d1e85233eb
Edoppler(300u"K")

# ╔═╡ 6bb59e14-cb53-4325-8fac-02b31e8a0709
gauss(x, T) = 1 / (Edoppler(T)  * sqrt(2π)) * exp( -0.5* (x/Edoppler(T))^2);

# ╔═╡ 21ca90b3-e7d3-4ad6-b2fe-e6ad011e0348
begin
	x = (-1:0.001:1) .* 0.2u"eV";
	plot(x, @. gauss(x - Erecoil, 300u"K"))
	plot!(x, @. gauss(x + Erecoil, 300u"K"))
end

# ╔═╡ 04640218-da30-4d0c-a9bd-bc1f15da7334
begin
	#x = (-1:0.001:1) .* 0.2u"eV";
	plot(x, @. gauss(x - Erecoil, 300u"K"))
	plot!(x, @. gauss(x + Erecoil, 80u"K"))
end

# ╔═╡ e655ae27-19ad-4a7b-b348-639905a4c06c
 overlap(T2) = sum(@. gauss(x - Erecoil, 300u"K") * gauss(x + Erecoil, T2))

# ╔═╡ ed648d6e-c45a-442a-ae46-dc13614891e6
begin
	trange = (1:400) .* 1u"K";
	plot(trange, @. overlap(trange) ./ overlap(300u"K"))
end

# ╔═╡ b888e274-7b46-4366-918b-e794cc8bf8f1
 overlap2(T2) = sum(@. gauss(x - Erecoil, T2) * gauss(x + Erecoil, T2))

# ╔═╡ 907fdbc1-134c-4aa6-b686-51d85dbd1ab0
	plot(trange, @. overlap2(trange) ./ overlap2(300u"K"))

# ╔═╡ 338e0bef-e16c-42a5-8096-fa51f8603b66
overlap2(88u"K") ./ overlap2(300u"K")
...
manifest_format = "2.0"
project_hash = "dd374bea07060457a3f4094814dc60dec25e83ec"
