...
# ╔═╡ 319258cc-d994-46c8-b4d2-850ae10cfc12
...
df = [CSV.read(name,DataFrame; header=2, normalizenames=true, drop=[3]) for name in names]
...
# ╔═╡ f0850788-6019-4293-a114-bc666a08c2de
df[1]
